...
const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  if (file) {
    ...
    const isVideo =
      file.type === "video/mp4" ||
      file.type === "video/quicktime" // quicktime = MOV
    ...
    // Your bucket limit is 10MB, but UX: show image <5MB, video <10MB message
    const sizeLimit = isImage ? 5 : 10 // in MB
    if (file.size > sizeLimit * 1024 * 1024) {
      alert(
        `❌ File too large. Images must be under 5MB, videos under 10MB.`
      )
      return
    }
              ...
              >
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Supported formats: JPG, PNG (up to 2MB) &nbsp;|&nbsp; MP4, MOV (up to 10MB)</p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-6 border border-green-200">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">{formData.uploadedFile.name}</p>
